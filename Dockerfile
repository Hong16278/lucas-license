...
LABEL org.opencontainers.image.title="Lucas License" \
      org.opencontainers.image.description="Self-hosted software activation and license management" \
      org.opencontainers.image.vendor="Lucas License contributors" \
      org.opencontainers.image.url="https://license.lucas.dpdns.org" \
      org.opencontainers.image.source="https://github.com/Hong16278/lucas-license" \
