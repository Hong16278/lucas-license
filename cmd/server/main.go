...
<script src="https://cdn.jsdelivr.net/npm/@scalar/api-reference"></script>
	...
	relWrite := v1.Group("/admin", relWriteMW...)
	{
		...
		licWrite.GET("/license-batches", adminH.ListLicenseBatches)
		licWrite.POST("/license-batches", adminH.CreateLicenseBatch)
		licWrite.GET("/license-batches/:id/export", adminH.ExportLicenseBatch)
