const en = {
  ...
  "plans.durationDays": "Days after first activation",
  "plans.durationDaysHelp": "Use 30 for monthly, 365 for yearly, and 0 for perpetual or externally billed plans.",
  ...
  "licenses.batchIssueDesc":
    "Generate unassigned keys for an external auto-delivery platform. The term starts on first activation.",
  "licenses.batchName": "Batch name",
  "licenses.channel": "Sales channel",
  "licenses.exportFormat": "Export format",
  "licenses.batchCreated": "Card batch generated; download started",
  "licenses.recentBatches": "Recent card batches",
  "licenses.recentBatchesDesc": "Download TXT or CSV again without generating replacement keys.",
  ...
  "releases.subtitle": "Distribute software updates to customers via Sparkle, Velopack, or Tauri.",
  "releases.signingKeys": "Signing keys",
  "releases.newRelease": "New release",
  "releases.allProducts": "All products",
  "releases.allChannels": "All channels",
  "releases.allStatuses": "All statuses",
  "releases.product": "Product",
  "releases.version": "Version",
  "releases.channel": "Channel",
  "releases.platform": "Platform",
  "releases.platforms": "Platforms",
  "releases.channelStable": "Stable",
  "releases.channelBeta": "Beta",
  "releases.channelAlpha": "Alpha",
  "releases.channelDev": "Development",
  ...
  "releases.openDetail": "Open release details",
  "releases.belowLatest": "below latest",
  "releases.belowLatestTitle": "Below current latest ({version})",
  "releases.platformCount": "{count} platform(s)",
  "releases.manageArtifacts": "View / manage artifacts",
  "releases.publish": "Publish",
  "releases.awaitingArtifacts": "Awaiting artifacts ({ready}/{total} ready)",
  "releases.yank": "Yank",
  "releases.restore": "Restore",
  "releases.deleteDraft": "Delete draft",
  "releases.deleteUseYank": "Cannot delete (yank instead)",
  "releases.noEligibleProducts": "No release-eligible products",
  "releases.noEligibleProductsDesc":
    "Release feeds are available for desktop and hybrid products only. Change a product type or create a desktop/hybrid product.",
  ...
  "releases.restoreTitle": "Restore v{version}?",
  "releases.restoreDesc":
    "This restores the release to the public update feed. Clients on the affected channel can receive v{version} again.",
  ...
  "releases.publishOlderTitle": "Publish a version below the current latest?",
  "releases.publishOlderDesc":
    "Version {version} is older than {latest}. Update clients reject downgrades by default. Publish it only when you intentionally need a backport.",
  "releases.publishAnyway": "Publish anyway",
  "releases.newReleaseDesc":
    "Create the release record, then add platform-specific installation packages in the next step.",
  "releases.displayName": "Display name (optional)",
  "releases.displayNamePlaceholder": "MyApp Pro",
  "releases.releaseNotes": "Release notes (optional, Markdown)",
  "releases.releaseNotesPlaceholder": "What's new in this version...",
  "releases.creating": "Creating...",
  "releases.createDraft": "Create draft",
  "releases.detailDraftDesc": "Add platform installation packages below. Publish when ready.",
  "releases.detailLockedDesc": "This release is {status}. Its artifacts can no longer be changed.",
  "releases.artifacts": "Artifacts ({count})",
  ...
  "releases.notUploaded": "Not uploaded yet",
  "releases.ready": "Ready",
  "releases.pending": "Pending",
  "releases.addArtifact": "Add artifact",
  "releases.addArtifactDesc":
    "Upload the {version} installation package. It is stored immediately and signed when the release is published.",
  "releases.artifactFile": "Installation package",
  "releases.platformFileRequired": "Select a platform and installation package.",
  "releases.uploadFailed": "Upload failed: {status}",
  "releases.reservingSlot": "Preparing the upload...",
  "releases.uploading": "Uploading to storage...",
  "releases.finalizing": "Calculating SHA-256 and finalizing...",
  "releases.processing": "Processing...",
  "releases.upload": "Upload",
  "releases.yankTitle": "Yank {version}?",
  "releases.yankDesc":
    "Yanking removes this release and all artifacts from update feeds. Existing installations keep working. The reason is saved to the audit log.",
  "releases.reason": "Reason",
  "releases.yankReasonPlaceholder": "For example: a critical bug was found; rollback is recommended.",
  "releases.signingKeysTitle": "Release signing keys",
  "releases.signingKeysDesc":
    "Generate an Ed25519 keypair for each product. Embed the public key in the client; the server signs installation packages with the private key when publishing.",
  "releases.noActiveKey": "No active signing key",
  "releases.noActiveKeyDesc": "Releases for this product remain unsigned until a key is generated.",
  "releases.generatingKey": "Generating...",
  "releases.generateKey": "Generate signing key",
  "releases.pastKeys": "Past keys ({count})",
  "releases.rotatedAt": "Rotated {date}",
  "releases.activeSigningKey": "Active signing key",
  "releases.createdAt": "Created {date}",
  "releases.publicKey": "Public key (Ed25519, Base64)",
  "releases.publicKeyHint": "Embed this key in the client's update signature verifier.",
  "releases.downloadPem": "Download .pem",
  "releases.rotate": "Rotate",
  "releases.deactivate": "Deactivate",
  "releases.rotateKeyTitle": "Rotate signing key?",
  "releases.rotateKeyDesc":
    "A new keypair will be generated and the old key kept as inactive history. Clients containing only the old public key cannot verify new releases.",
  "releases.reasonAudit": "Reason (audit log)",
  "releases.rotateReasonPlaceholder": "For example: routine key rotation.",
  "releases.rotating": "Rotating...",
  "releases.deactivateKeyTitle": "Deactivate signing key?",
  "releases.deactivateKeyDesc":
    "Future releases will be unsigned until a new key is generated. Clients enforcing signature checks will reject unsigned updates.",
  "releases.deactivateReasonPlaceholder": "Why are you deactivating this key?",
  "releases.deactivating": "Deactivating...",
  "releases.toastPublished": "Release published.",
  "releases.toastRestored": "Release restored.",
  "releases.toastDraftDeleted": "Draft deleted.",
  "releases.toastDraftCreated": "Draft {version} created. Add artifacts before publishing.",
  "releases.toastArtifactUploaded": "Artifact for {platform} uploaded.",
  "releases.toastYanked": "Release yanked.",
  "releases.toastKeyGenerated": "Signing key generated.",
  "releases.toastKeyRotated": "Signing key rotated.",
  "releases.toastKeyDeactivated": "Signing key deactivated.",
