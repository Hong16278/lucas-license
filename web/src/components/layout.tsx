    ...
    <div className="flex h-screen bg-background">
      ...
      <aside className="w-60 border-r bg-card flex flex-col">
        ...
        <div className="px-4 py-2 border-t text-center">
          ...
          <span className="mx-1 text-[10px] text-muted-foreground/30">·</span>
          <SourceCodeLink className="text-[10px] text-muted-foreground/50 hover:text-muted-foreground transition-colors" />
        </div>
      </aside>
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <footer className="border-t py-3 text-center">
        ...
        <span className="mx-1 text-xs text-muted-foreground/30">·</span>
        <SourceCodeLink className="text-xs text-muted-foreground/50 hover:text-muted-foreground transition-colors" />
      </footer>
    </div>
  )
}
