...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-muted/30">
      ...
      <div className="mt-4 flex items-center gap-1 text-[10px] text-muted-foreground/40">
        <a href={attribution_url} target="_blank" rel="noopener noreferrer" className="hover:text-muted-foreground transition-colors">
          {attribution_text}
        </a>
        <span>·</span>
        <SourceCodeLink className="hover:text-muted-foreground transition-colors" />
      </div>
    </div>
  )
}
